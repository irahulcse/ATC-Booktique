...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="mname" id="name1" placeholder="Name" required/>
</div>
<div class="form-group">
    <label for="name1">Member Address</label>
    <input type="text" class="form-control" name="maddress" id="name1" placeholder="Address" required/>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="mcity" id="name1" placeholder="City" required/>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="superviser_name" id="name1" placeholder="Superviser Name" required/>
</div>
<div class="form-group">
    <label for="name1">Superviser Email Id</label>
    <input type="text" class="form-control" name="superviser_emailid" id="name1" placeholder="Superviser Email Id" required/>
</div>
